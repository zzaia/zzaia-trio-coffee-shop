...
{
    /// <inheritdoc />
    public partial class SeedProductCatalogAndUsers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                schema: "order",
                table: "products",
                columns: new[] { "product_id", "name", "description", "base_price_amount", "currency", "category", "image_url", "is_available" },
                values: new object[,]
                {
                    { latteId, "Latte", "Smooth espresso with steamed milk", 4.00m, "BRL", "Coffee", null, true },
                    { espressoId, "Espresso", "Rich and bold espresso shot", 2.50m, "BRL", "Coffee", null, true },
                    { macchiatoId, "Macchiato", "Espresso with a touch of steamed milk", 4.00m, "BRL", "Coffee", null, true },
                    { icedCoffeeId, "Iced Coffee", "Refreshing cold-brewed coffee", 3.50m, "BRL", "Coffee", null, true },
                    { donutsId, "Donuts", "Freshly baked donuts", 2.00m, "BRL", "Pastry", null, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "variation_id", "product_id", "name", "price_adjustment_amount", "currency" },
                values: new object[,]
                {
                    // Latte Variations
                    { Guid.Parse("a1111111-1111-1111-1111-111111111111"), latteId, "Pumpkin Spice", 0.50m, "BRL" },
                    { Guid.Parse("a1111111-1111-1111-1111-111111111112"), latteId, "Vanilla", 0.30m, "BRL" },
                    { Guid.Parse("a1111111-1111-1111-1111-111111111113"), latteId, "Hazelnut", 0.40m, "BRL" },

                    // Espresso Variations
                    { Guid.Parse("a2222222-2222-2222-2222-222222222221"), espressoId, "Single Shot", 0.00m, "BRL" },
                    { Guid.Parse("a2222222-2222-2222-2222-222222222222"), espressoId, "Double Shot", 1.00m, "BRL" },

                    // Macchiato Variations
                    { Guid.Parse("a3333333-3333-3333-3333-333333333331"), macchiatoId, "Caramel", 0.50m, "BRL" },
                    { Guid.Parse("a3333333-3333-3333-3333-333333333332"), macchiatoId, "Vanilla", 0.30m, "BRL" },

                    // Iced Coffee Variations
                    { Guid.Parse("a4444444-4444-4444-4444-444444444441"), icedCoffeeId, "Regular", 0.00m, "BRL" },
                    { Guid.Parse("a4444444-4444-4444-4444-444444444442"), icedCoffeeId, "Sweetened", 0.30m, "BRL" },
                    { Guid.Parse("a4444444-4444-4444-4444-444444444443"), icedCoffeeId, "Extra Ice", 0.20m, "BRL" },

                    // Donuts Variations
                    { Guid.Parse("a5555555-5555-5555-5555-555555555551"), donutsId, "Glazed", 0.00m, "BRL" },
                    { Guid.Parse("a5555555-5555-5555-5555-555555555552"), donutsId, "Jelly", 0.30m, "BRL" },
                    { Guid.Parse("a5555555-5555-5555-5555-555555555553"), donutsId, "Boston Cream", 0.50m, "BRL" }
                });
        }
